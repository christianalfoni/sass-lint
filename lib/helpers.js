...
var util = require('util'),
    merge = require('merge'),
    concentricFile = require('./config/property-sort-orders/concentric.js'),
    recessFile = require('./config/property-sort-orders/recess.js'),
    smacssFile = require('./config/property-sort-orders/smacss.js');

var files = {
  'property-sort-orders/concentric.yml': concentricFile,
  'property-sort-orders/recess.yml': recessFile,
  'property-sort-orders/smacss.yml': smacssFile
};
